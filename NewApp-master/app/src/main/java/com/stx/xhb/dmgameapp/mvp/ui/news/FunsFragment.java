 ...
 * @author lx
 */
public class FunsFragment extends BaseMvpFragment<GetNewsListPresenter> implements GetNewsListContract.getNewListView, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        currentpage = 1;
        mPresenter.getAmusePage(currentpage);
    }
