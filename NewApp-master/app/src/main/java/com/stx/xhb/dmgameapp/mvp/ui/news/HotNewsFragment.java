 ...
 * @author lx
 */
public class HotNewsFragment extends BaseMvpFragment<GetNewsListPresenter> implements GetNewsListContract.getNewListView, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        currentpage = 1;
        mPresenter.getHotNewsList(currentpage);
    }
